...
HYP=ROOT/'04_analysis_design'/'호텔검색_가설문서_결과없음_재검색_세그먼트_296건기준_20260902_v08_통합완성본.docx'
PLAN=ROOT/'04_analysis_design'/'호텔검색_데이터증강계획서_세그먼트가설중심_296건기준_20260902_v06_통합완성본.docx'
...
bullet(d,'기준 DB: 03_data_modeling/'+DB+' — USER 89, SEARCH 296, SEARCH_FILTER 296, 검색 세션 43.')
