...
OUT=ROOT/'06_가이드와프롬프트'/'호텔검색_데이터분석_쉬운용어사전_표본설계가중치_20260902_v01.docx'
...
p=d.add_paragraph(); font(p.add_run('기준 파일: '),10.5,True); font(p.add_run('03_데이터모델링/이전버전/데이터셋/2026-09-01_v01/travel_data_filtered_complete_2026-09-01_v01_원본.sqlite'),10.5)
