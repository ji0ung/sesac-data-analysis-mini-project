...
def render():
    ...
    for name in ("site_entry", "site_console", "site_experiment", "simulation_scope", "simulation_calibration", "simulation_impacts", "research", "survey", "topic", "team", "hypotheses", "lessons", "augmentation", "limitations", "optimization"):
