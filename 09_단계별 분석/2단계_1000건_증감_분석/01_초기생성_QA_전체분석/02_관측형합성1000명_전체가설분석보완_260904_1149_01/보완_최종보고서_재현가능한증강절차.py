...
code(d,'python "09_단계별 분석/2단계_1000건_증감_분석/01_초기생성_QA_전체분석/02_관측형합성1000명_실행묶음_260903_1606_01/호텔검색_관측형합성1000명_생성코드_260903_1606_01.py" --db "travel_data_filtered_complete_2026-09-03_v02_비식별.sqlite" --config "09_단계별 분석/2단계_1000건_증감_분석/01_초기생성_QA_전체분석/02_관측형합성1000명_실행묶음_260903_1606_01/호텔검색_관측형합성1000명_생성설정_260903_1606_01.json" --output-dir "<새로운_빈_출력폴더>"')
