...
def render():
    ...
    for name in ("data_summary", "segments", "hypotheses", "site_entry", "site_experiment", "simulation_scope", "simulation_calibration", "simulation_impacts", "research", "topic", "team", "lessons", "augmentation", "limitations", "optimization"):
